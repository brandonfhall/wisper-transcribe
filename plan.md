...
>
> Design work only — no code has been written against this plan. Preserved from the retired `feat/intel-arc-gpu` branch (single-commit design spike, 2026-05-31) so the research isn't lost; pick up here whenever this becomes a priority.
